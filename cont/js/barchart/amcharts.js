...
(function () {
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            this.fontFamily = "As-Nova";//шрифт типчика, и не только
            this.fontSize = 18;//размер шрифта типчика, и к сожалению не только типчика
            this.usePrefixes = !1;
            this.autoResize = !0;
            this.autoDisplay = !1;
...
(function () {
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            this.enabled = !0;
            this.fillColor = "#000000"; //бэкграунд типчика
            this.fillAlpha = .8; //прозрачность бэка типчика
            this.borderThickness = 0; //толщина бордера
            this.borderColor = "#FFFFFF";
            this.borderAlpha = 0; //непрозрачность бордера
            this.cornerRadius = 0; //радиус скругления углов
            this.maxWidth = 300;
            this.horizontalPadding = 15; //8. тут находятся педдинги, а в начале их изначальные значения
            this.verticalPadding = 5; //4. тут находятся педдинги, а в начале их изначальные значения
            this.pointerWidth = 6;
            this.pointerOrientation = "V";
            this.color = "#ffffff"; //цвет текста типчика
